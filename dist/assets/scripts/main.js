...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"form\", function() { return form; });\nvar form = document.querySelector('.form-location');\n\n\n//# sourceURL=webpack:///./src/dom.js?");
...
/*!***********************!*\
  !*** ./src/script.js ***!
  \***********************/
/*! exports provided: weatherCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"weatherCheck\", function() { return weatherCheck; });\n/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom */ \"./src/dom.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar cityKey = \"QqFCfLuVXyO7oxFlgu4nWgRjh5hYjgVA\";\nvar cityBase = 'http://dataservice.accuweather.com/locations/v1/cities/search';\n\"<div class=\\\"alert alert-warning alert-dismissible fade show\\\" role=\\\"alert\\\">\\n<strong>Holy guacamole!</strong> You should check in on some of those fields below.\\n<button type=\\\"button\\\" class=\\\"close\\\" data-dismiss=\\\"alert\\\" aria-label=\\\"Close\\\">\\n<span aria-hidden=\\\"true\\\">&times;</span>\\n</button>\\n</div>\"; //get city data from accuweather api\n\nfunction Templates() {\n  return {\n    ulTemplate: function ulTemplate(data) {\n      \"   <li><span>\".concat(data, \"</span><span>\").concat(data.Country.EnglishName, \"</span></li>\");\n    }\n  };\n}\n\nfunction weatherCheck() {\n  return {\n    locationKey: \"QqFCfLuVXyO7oxFlgu4nWgRjh5hYjgVA\",\n    city: \"\",\n    getCity: function getCity(city, base, key) {\n      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var query, response, data;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                query = \"?apikey=\".concat(key, \"&q=\").concat(city);\n                _context.next = 3;\n                return fetch(base + query);\n\n              case 3:\n                response = _context.sent;\n                _context.next = 6;\n                return response.json();\n\n              case 6:\n                data = _context.sent;\n                return _context.abrupt(\"return\", data);\n\n              case 8:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee);\n      }))();\n    },\n    render: function render(node, clas, data) {\n      var container = document.createElement('ul');\n      var searchUl = \" <li><span>\".concat(data.EnglishName, \"</span><span>\").concat(data.Country.EnglishName, \"</span></li>\");\n      container.classList = clas;\n      container.innerHTML = \"\";\n      container.innerHTML = searchUl;\n      node.appendChild(container);\n    },\n    outputCity: function outputCity(data) {\n      var _this = this;\n\n      if (data.length) {\n        if (data.length > 5) {\n          data = data.filter(function (val) {\n            return val.Country.EnglishName !== data[0].Country.EnglishName;\n          });\n          data.forEach(function (val) {\n            _this.render(document.querySelector('.search'), 'search-res', val);\n          });\n        } else if (data.length < 5) {\n          data.forEach(function (val) {\n            _this.render(document.querySelector('.search'), 'search-res', val);\n          });\n        }\n      }\n    },\n    startCheck: function startCheck() {\n      var _this2 = this;\n\n      _dom__WEBPACK_IMPORTED_MODULE_0__[\"form\"].addEventListener('submit', function (e) {\n        e.preventDefault(); //grab data from api base on input\n\n        _this2.getCity(_dom__WEBPACK_IMPORTED_MODULE_0__[\"form\"].location.value, cityBase, cityKey).then(function (data) {\n          _this2.outputCity(data);\n\n          _this2.city = data[0].EnglishName;\n        })[\"catch\"](function (err) {\n          return console.log(err);\n        });\n      });\n    }\n  };\n}\n\n\n\n//# sourceURL=webpack:///./src/script.js?");
